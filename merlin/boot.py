#--------------------------Importing Functions----------------------
import os
import pyttsx3 #Talk function helper
...
username = "harsha"
mode = 0
mode_print=['general','web browser','python','smart','ultimate','web development']
#--------------------------Defined modes-----------------------------
#           0 = General ( Default )
#           1 = Webbrowser ( easy Internet access )
#           2 = python mode ( IDLE )
#           3 = smart mode ( command run )
#           4 = ultimate mode ( Assistant mode )
#           5 = webdevelopment ( brackets editor )
#--------------------------TALKING FUNCTION--------------------------
rey1 = pyttsx3.init()
def engine2(text):
    rey1.say(text)
